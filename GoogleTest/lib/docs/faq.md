...
result, any in-memory _side effects they incur are observable in their respective
...
program can run _side-by-_side with itself and is deterministic.
...
*   The googletest team is considering making the assertion macros throw on
    ...
    client-_side), which will eliminate the need for the user to propagate
...
1.  It's likely your test needs to change the states of its global variables.
    This makes it difficult to keep _side effects from escaping one test and
