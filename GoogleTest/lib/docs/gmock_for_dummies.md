...
*   You need to make sure that your module interacts with other modules in the
    ...
    observing the _side effects at the end of the action, but it's awkward at
    best.
...
must be careful about _side effects. The following may not do what you want:
...
return the same pointer every time. If you want the _side effect to happen every
